...
tf.app.flags.DEFINE_string('methodology_key', 'methodology',
                           'tf.Example feature key for methodology.')
tf.app.flags.DEFINE_string('method_summary_key', 'method_summary',
                           'tf.Example feature key for methodology summary.')
...
tf.app.flags.DEFINE_float('rand_unif_init_mag', 0.05, 'magnitude for lstm cells random uniform initialization')
...
tf.app.flags.DEFINE_float('min_abstract_len', 10, 'Discards articles with short abstracts')
...
def main(unused_argv):
    ...
    batcher = Batcher(FLAGS.data_path, vocab, hps,
                      ...
                      FLAGS.methodology_key,
                      FLAGS.method_summary_key)
